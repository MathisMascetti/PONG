var game = {
    ...
    ball : {
        ...
        move : function() {
          ...
          bounce : function(wallSound) {
            if ( this.posX > game.groundWidth/*/conf.GROUNDLAYERWIDTH /*/|| this.posX < 0 ) {
              this.directionX = -this.directionX;
              wallSound.play();
            }
            if ( this.posY > game.groundHeight/*/conf.GROUNDLAYERHEIGHT /*/ || this.posY < 0  ) {
    ...
    init : function() {
      ...
      this.initMouse(game.control.onMouseMove);
        ...
        this.wallSound = new Audio("./sound/dbz.mp3");
        this.playerSound = new Audio("./sound/wow.mp3");
